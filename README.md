...
## 협업
`wafflestudio-web`의 협업은 기본적으로 레포지토리 내에서 진행됩니다. 그러나 다른 팀과의 협업을 위해 노션의 칸반을 이용하여 진행상황 및 보고 내용을 관리할 예정입니다.
- 작업할 내용이 생길 경우 레포지토리의 Issue 템플릿을 사용하여 성격에 맞게 등록합니다.
  - 노션에도 칸반을 생성하고 이슈의 링크를 적어 놓습니다.
- 해당 이슈에 대응하는 브랜치를 만들고, 작업을 진행합니다. 칸반도 알맞게 이동합니다.
- Pull Request를 올릴 때 작업의 시작점이 된 이슈를 명시하고, 기타 내용도 템플릿에 맞게 작성합니다.
  - 칸반에 PR의 링크를 달고 작업 상태를 `보고`로 설정합니다
